  ...
  setup() {
    ...
    return () => (
      ...
      >
        <TabList
          class={clsx(
            'space-x-2 rounded-xl bg-neutral-900/50 inline-block py-1 px-1 -ml-1',
            '[&>button]:(rounded-lg py-2.5 px-4 text-sm font-medium leading-5 ring-white/60 ring-offset-2 ring-offset-primary-100 !outline-none focus:ring-2)',
          )}
        >
