...
const styles = {
  ...
  tab: 'w-16 box-border data-[headlessui-state="selected"]:(text-primary-700)',
}
...
export const HomeTabs = defineComponent({
  ...
  setup() {
    ...
    return () => {
      const finIndex = selectedIndex.value < 0 ? 0 : selectedIndex.value
      return (
        <TabGroup
          defaultIndex={0}
          selectedIndex={finIndex}
          onChange={(index) => {
            router.replace({
              query: {
                ...route.query,
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                left: `calc(4rem * ${finIndex} - 0.25rem + ${finIndex} * 0.5rem)`,
              }}
            ></div>
          </TabList>
